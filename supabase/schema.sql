-- Student Portal — roles: admin manages catalog, students enroll
...
-- course catalog
drop policy if exists "catalog_select_auth" on public.course_catalog;
drop policy if exists "catalog_insert_admin" on public.course_catalog;
drop policy if exists "catalog_update_admin" on public.course_catalog;
drop policy if exists "catalog_delete_admin" on public.course_catalog;
